    ...
    exampleMessages: [
      {
        ...
        message: `你現在是一個大學教授，而我是一個想升學的高中生，請幫我進行一場大學科系的模擬面試，幫我增加對面試的熟悉程度與答題能力，你需要遵守以下規則：1. 你只能問我有關指定科系的面試問題。2. 不用寫解釋。3. 你需要向面試官一樣等我回答問題，再提問下一個問題。等我告訴你我要練習面試的大學科系後，請先問我我的自我介紹`
      },
      {
        heading: '幫我改善',
        subheading: '我寫的自我介紹',
